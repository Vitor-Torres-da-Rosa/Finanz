...
const casos = {
  'completo': { contas:[{id:'a-t48',nome:'Nubank',tipo:'Conta corrente',saldoInicial:0,cor:'#fff'}],
    lancamentos:[{id:'l1-t48',tipo:'entrada',valor:1000,categoria:'Salário',descricao:'x',data:'2026-01-05',contaId:'a-t48'}],
    ...
    perfil:{nome:'Vitor'} },
  'sem telefones (antigo)': { contas:[{id:'a-t48',nome:'X',tipo:'Conta corrente',saldoInicial:0}],
    lancamentos:[], clientes:[{id:'c1',nome:'João',telefone:'51999999999'}] },
  'parcela sem cliente': { contas:[{id:'a-t48',nome:'X',tipo:'Conta corrente',saldoInicial:0}], lancamentos:[],
    parcelas:[{id:'p1',numero:1,valor:100}] },
  'nulos': { contas:[null,{id:'a-t48',nome:'X',tipo:'Conta corrente',saldoInicial:0}], lancamentos:[null],
    clientes:[null], servicos:[null], parcelas:[null], pagamentos:[null], metas:[null], ativos:[null] },
  'campos faltando': { contas:[{id:'a-t48',nome:'X'}], lancamentos:[{id:'l1-t48'}], clientes:[{id:'c1',nome:'J'}],
