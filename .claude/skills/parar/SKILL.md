...
2. Liste as Routines com `list_triggers` e apague com `delete_trigger`
   **todos** os degraus `finanz-retomar-*` criados pelo `/sempre`. Um
   degrau esquecido acorda a conversa sozinho dias depois.
